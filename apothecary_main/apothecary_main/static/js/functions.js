 ...
 * Post like Counter 
 * --------------------------------------------------------------------------- */
function medicinebakery_post_likes_count(admin_url, id, obj) {
    "use strict";

    var dataString = 'post_id=' + id + '&action=medicinebakery_post_likes_count';
...
function medicinebakery_show_response_theme(loader_data, loading_element) {

    jQuery(".medicinebakery_loader").hide();
    jQuery("#growls").removeClass('medicinebakery_element_growl');
    ...
    if (loader_data != 'undefined' && loader_data != '') {
        ...
        if (loader_data.type != 'undefined' && loader_data.type == 'error') {
            ...
            if (loading_element != 'undefined' && loading_element != undefined && loading_element != '') {
                ...
                jQuery("#growls").addClass('medicinebakery_element_growl');
...
jQuery(document).ready(function ($) {
    if (jQuery(".medicinebakery-fancy-menu li.current-menu-parent a").length > 0) {
        jQuery(".medicinebakery-fancy-menu li.current-menu-parent a").click();
    } else if (jQuery(".medicinebakery-fancy-menu li").first().children('ul.sub-menu').length > 0) {
        jQuery(".medicinebakery-fancy-menu li").first().children('ul.sub-menu').slideDown();
        jQuery(".medicinebakery-fancy-menu li").first().addClass('active');
    }
    /*Back To Top Start*/
